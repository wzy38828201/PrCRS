...
test_num = 30
savedir = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\data2'
#savedir = './data2'
...
np.save(os.path.join(savedir, 'data2_train多.npy'), np.array(train_data2_feats_label))
np.save(os.path.join(savedir, 'data2_valid多.npy'), np.array(valid_data2_feats_label))
np.save(os.path.join(savedir, 'data2_test多.npy'), np.array(test_data2_feats_label))
