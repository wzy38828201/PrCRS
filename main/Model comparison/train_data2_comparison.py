...
def train():
    ...
    for ilr in lr:
        for jbs in bs:
            path = r'main/Model comparison/PrCRS'
            ...
            collate_fn = Collate()
            batch_size =jbs#20
            trainset = Dataset(r'main/data/1_day/data2_train2.npy')
            train_loader = DataLoader(trainset, num_workers=0,
                                      shuffle=False, batch_size=batch_size,
                                      pin_memory=False, drop_last=True,
                                      collate_fn=collate_fn)

            devset = Dataset(r'main/data/1_day/data2_valid2.npy')
            dev_loader = DataLoader(devset, num_workers=0,
                                      shuffle=False, batch_size=1,
                                      pin_memory=False, drop_last=True,
                                      collate_fn=collate_fn)

            testset = Dataset(r'main/data/1_day/data2_test2.npy')
            ...
            if len(dic.keys())==0:
                ...
                file_handle = open(r'main/outputs2/1_day.txt', mode='a+')
