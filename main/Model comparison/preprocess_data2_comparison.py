...
#common_keys = ['red blood cell', 'hemoglobin', 'leukocyte','Neutrophil percentage', 'Neutrophil count', 'Lymphocyte percentage', 'Lymphocyte count','platelet', 'Monocyte percentage', 'Monocyte count'] #Blood routine examination3
#common_keys = ['sodium', 'potassium', 'chlorine', 'calcium', 'Uric acid', 'glucose', 'triglyceride', 'gamma glutamyl transpeptidase','albumin', 'Glutamic pyruvic transaminase', 'Glutamic oxalacetic transaminase', 'Alkaline phosphatase', 'Lactate dehydrogenase', 'creatinine', 'C-reactive protein', 'ferritin']#Biochemical term2
#common_keys = ['red blood cell', 'hemoglobin', 'leukocyte','Neutrophil percentage', 'Neutrophil count', 'Lymphocyte percentage', 'Lymphocyte count','platelet', 'Monocyte percentage', 'Monocyte count', #Blood routine examination3
#    'sodium', 'potassium', 'chlorine', 'calcium', 'Uric acid', 'glucose', 'triglyceride', 'gamma glutamyl transpeptidase','albumin', 'Glutamic pyruvic transaminase', 'Glutamic oxalacetic transaminase', 'Alkaline phosphatase', 'Lactate dehydrogenase', 'creatinine', 'C-reactive protein', 'ferritin']#Biochemical term2
