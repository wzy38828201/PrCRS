...
def train():
    ...
    for ilr in lr:
        for jbs in bs:
            ...
            data1_ckpt = 'main/outputs1/Primitive_transfer.pt'
            ...
            devset = Dataset('main/data/3_day/data2_valid2.npy')
            ...
            if len(dic.keys())==0:
                ...
                file_handle = open(r'main/outputs2/3_day/3_day.txt', mode='a+')
                file_handle.write('The best model to remove cytokines：'+str(max_keyc)+str(dicc[max_keyc])+'\n')
