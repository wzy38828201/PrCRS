...
a = pd.read_excel(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\12个人.xlsx')

load_npy = np.load(r"G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\data12.npy")
...
b = pd.read_excel(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\W12总.xlsx')
z[0] = b[0]
z[1] = b[1]
z.to_excel(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\概率对应.xlsx',index = 0)
