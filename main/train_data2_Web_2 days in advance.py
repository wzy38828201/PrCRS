...
def train():
    ...
    for ilr in lr:
        for jbs in bs:
            ...
            data1_ckpt = 'main/outputs1/2_day/Primitive_transfer.pt'
            ...
            devset = Dataset('main/data/2_day/data2_valid2.npy')
            ...
            if len(dic.keys())==0:
                ...
                file_handle = open(r'main/outputs2/2_day.txt', mode='a+')
