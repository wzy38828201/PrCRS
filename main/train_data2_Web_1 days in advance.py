...
def train():
    ...
    for ilr in lr:
        for jbs in bs:
            ...
            data1_ckpt = 'main/outputs1/Primitive_transfer.pt'#Read the best model
            ...
            collate_fn = Collate()
            batch_size =jbs#20
            trainset = Dataset('main/data/1_day/data2_train.npy')
            train_loader = DataLoader(trainset, num_workers=0,
                                      shuffle=False, batch_size=batch_size,
                                      pin_memory=False, drop_last=True,
                                      collate_fn=collate_fn)

            devset = Dataset('main/data/1_day/data2_valid.npy')
            dev_loader = DataLoader(devset, num_workers=0,
                                      shuffle=False, batch_size=1,
                                      pin_memory=False, drop_last=True,
                                      collate_fn=collate_fn)

            testset = Dataset('main/data/1_day/data2_test.npy')
            ...
            if len(dic.keys())==0:
                ...
                file_handle = open(r'main/outputs2/1_day/1_day.txt', mode='a+')
