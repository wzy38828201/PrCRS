...
#xlsx_file2 = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\9个测试\193.xlsx'
xlsx_file2 = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\5个新的\记录.xlsx'
...
df1__0 = df2__[df2__['CRS'] == 0].sample(frac=0.5)
df1__1 = df2__[df2__['CRS'] == 1].sample(frac=0.5)
df1__2 = df2__[df2__['CRS'] == 2].sample(frac=0.5)
df1__3 = df2__[df2__['CRS'] == 3].sample(frac=0.5)
df1__4 = df2__[df2__['CRS'] == 4].sample(frac=0.5)
...
test_num = 30
savedir = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\5个新的'
#savedir = './data2'
...
quanbu = data2_feats_label

print('train_data2_feats_label: ', np.array(train_data2_feats_label).shape)
np.save(os.path.join(savedir, 'data5.npy'), np.array(quanbu))
#np.save(os.path.join(savedir, 'data193.npy'), np.array(quanbu))
#np.save(os.path.join(savedir, 'data193_train.npy'), np.array(train_data2_feats_label))
#np.save(os.path.join(savedir, 'data193_valid.npy'), np.array(valid_data2_feats_label))
#np.save(os.path.join(savedir, 'data193_test.npy'), np.array(test_data2_feats_label))
