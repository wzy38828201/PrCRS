...
with torch.no_grad():
    np.save(os.path.join(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\output迁移提前3天\c', 'dc.npy'), np.array(xx))
    #print('aaaaaaa')
    testset = Dataset(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\output迁移提前3天\c\dc.npy')
    #print('aaaaaaa')
