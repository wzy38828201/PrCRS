...
def train():
    ...
    for ilr in lr:
        for jbs in bs:
            path = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\模型'
...
#            # 迁移学习
            ...
            collate_fn = Collate()
            batch_size =jbs#20
            trainset = Dataset(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\data190_train.npy')
            train_loader = DataLoader(trainset, num_workers=0,
                                      shuffle=False, batch_size=batch_size,
                                      pin_memory=False, drop_last=True,
                                      collate_fn=collate_fn)

            devset = Dataset(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\data190_valid.npy')
            dev_loader = DataLoader(devset, num_workers=0,
                                      shuffle=False, batch_size=1,
                                      pin_memory=False, drop_last=True,
                                      collate_fn=collate_fn)

            testset = Dataset(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\data190_test.npy')
            ...
            if len(dic.keys())==0:
                ...
                file_handle = open(r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\模型\当天.txt', mode='a+')
