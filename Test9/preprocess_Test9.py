...
xlsx_file2 = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\190个人.xlsx'
#xlsx_file2 = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试\12个人.xlsx'
...
test_num = 30
savedir = r'G:\图神经网络编程\深度学习预测CRS\迁移学习\code2\是否迁移效果比较\12个测试'
#savedir = './data2'
...
#np.save(os.path.join(savedir, 'data12.npy'), np.array(quanbu))
#np.save(os.path.join(savedir, 'data190.npy'), np.array(quanbu))
#np.save(os.path.join(savedir, 'data190_train.npy'), np.array(train_data2_feats_label))
#np.save(os.path.join(savedir, 'data190_valid.npy'), np.array(valid_data2_feats_label))
#np.save(os.path.join(savedir, 'data190_test.npy'), np.array(test_data2_feats_label))
